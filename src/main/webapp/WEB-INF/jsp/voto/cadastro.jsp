...
<body>
	...
	<div class="container mt-3">
		...
		<form action="/voto/incluir" method="post">
			...
			<div class="mb-3 mt-3">
				<label>Eleição:</label> <input type="text" class="form-control"
			...
			<input type="hidden" name="eleicao.id" value="${eleicao.id}">
			<div class="mb-3 mt-3">
				<label>localizacao:</label> <input type="text" class="form-control"
					placeholder="Entre com a localizacao" name="localizacao"
					value="rua primeira">
			</div>
